...
\FullName{Dylan Russell Schlichting}      % Enter full name
\Chair{Henry Potter}               % Enter name of committee chair
\CoChair{Robert Hetland}         % Enter name of committee co-chair
\MemberOne{Spencer Jones}   % Name of first committee member
\MemberTwo{Scott Socolofsky}   % Name of second committee member
% \MemberThree{} % Name of third committee member
\DeptHead{Shari Yvon-Lewis}    % Enter name of department head
...
\include{./Data/Section1_Introduction} % Include the Section1.tex file --- Introduction 
\include{./Data/Section2_Ch1_james_2023} % Include the Section2.tex file --- Chapter 1
\include{./Data/Section3_Ch2_shelfstrat_2024} % Include the Section3.tex file --- Chapter 2
\include{./Data/Section4_Ch3_mpaso.tex}		% Include the Section4.tex file --- Chapter 3
\include{./Data/Section5_Conclusion}       % Include the Section5.tex
...
\begin{appendices}
    \include{./Data/appendix1_Ch1}			% Include the appendix1.tex file
    \include{./Data/appendix2_Ch2}			% Include the appendix2.tex file
\end{appendices}
